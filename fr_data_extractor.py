...
class FrDataExtractor:
    ...
    def __set_column_names(self, delimiter):
        ...
        return delimiter.join(self.columns) + ",image_path" # Also adding file_path as a column
    ...
    def __format_line(self, line, delimiter):
        ...
        if(len(line.split("_")) == len(self.columns)): # Checking that the length matches input of columns (or ignore line)
        ...
        try:
            ...
            for r, d, f in os.walk(path):
                for file in f:
                    ...
                    if file_str in file:
                        files.append(os.path.join(r, file).replace(self.image_path + "/", ""))
        ...
        try:
            ...
            try:
                ...
                for line in self.__read_dir():
                    ...
                    if formatted_line:
                        f.write(formatted_line + delimiter + self.image_path + "/" + line + '\n')
            finally:
